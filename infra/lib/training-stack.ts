...
export class TrainingStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const reportsLambda = new lambda.Function(this, 'ReportsApiLambda', {
            ...
            code: lambda.Code.fromAsset(path.join(__dirname, '../../backend/lambda/reports-api')),
            memorySize: 256,
        ...
        new cdk.CfnOutput(this, 'ApiUrl', {
            ...
            exportName: 'CpakReportsApiUrl',
        });

        new cdk.CfnOutput(this, 'AmplifyAppId', {
            value: amplifyApp.appId,
            description: 'Amplify App ID',
            exportName: 'CpakReportsAmplifyAppId',
        });
        ...
        new cdk.CfnOutput(this, 'AmplifyUrl', {
            ...
            exportName: 'CpakReportsAmplifyUrl',
        });
    }
}

...
class ModelPredictor:
    ...
    def __init__(self, checkpoint_path):
        ...
        print(f"ModelPredictor using device: {self.device}")
    ...
    def predict_leg(self, leg_image):
        """Run inference on a single leg image. Returns keypoints in leg coordinates."""
        h, w = leg_image.shape

        resized = cv2.resize(leg_image, (self.input_width, self.input_height),
...
class AnnotationToolV3PerfOnly:
    ...
    def __init__(self, root):
        ...
        print("Loading model...")
        try:
            self.predictor = ModelPredictor(CHECKPOINT_PATH)
    ...
    def setup_ui(self):
        ...
        # Point Legend
        legend_frame = ttk.LabelFrame(sidebar, text="Point Legend (drag to adjust)", padding=10)
        ...
        # Status
        self.status_label = ttk.Label(sidebar, text="Drag points to adjust, drag elsewhere to pan",
        ...
        ttk.Button(action_frame, text="Reset Points (R)",
    ...
    def load_leg(self):
        """Load current leg and run model prediction."""
    ...
    def on_mouse_down(self, event):
        """Start dragging - either a point or panning the image."""
    ...
    def reset_points(self):
        """Re-run model prediction for current leg."""
        self.load_leg()
        self.status_label.config(text="Points reset to model prediction")
